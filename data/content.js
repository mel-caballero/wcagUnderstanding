const wcagObj = {
  criterion : [
    { // 1.1.1.
      ...
      "goal" : 
      {
        "ca" : "Proporcioneu alternatives de text per a qualsevol contingut que no sigui de text perquè es pugui canviar a altres formes que les persones necessitin, com ara lletra gran, braille, parla, símbols o un llenguatge més simple.", 
    ...
    { // 1.2.1.
      "criteria" : 
      {
        "ca" : "1.2.1 Només àudio i només vídeo (pregravat)", 
      ...
      "benefits" :
      {
        "ca" : "<ul><li>Aquest criteri d'èxit ajuda les persones que tenen dificultats per percebre el contingut visual. La tecnologia d'assistència pot llegir alternatives de text en veu alta, presentar-les visualment o convertir-les en braille.</li><li>Les alternatives per a mitjans cronometrats que es basen en text poden ajudar a algunes persones que tenen dificultats per entendre el significat del contingut de vídeo pregravat.</li><li>Les persones sordes, tenen problemes d'audició o tenen problemes per entendre la informació d'àudio per qualsevol motiu poden llegir la presentació del text. S'estan realitzant investigacions sobre la traducció automàtica de text a la llengua de signes.</li><li>Les persones sordcegues poden llegir el text en braille.</li><li>A més, el text admet la possibilitat de cercar contingut que no sigui de text i de reutilitzar el contingut de diverses maneres.</li></ul>", 
    ...
    { // 1.4.1.
      ...
      "examples" : "https://www.w3.org/WAI/WCAG21/Understanding/use-of-color.html#benefits",
    ...
    { // 1.4.3.
      ...
      "examples" : "https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum.html#benefits",
    ...
    { // 1.4.6.
      ...
      "examples" : "w3.org/WAI/WCAG21/Understanding/contrast-enhanced.html#benefits",
    ...
    { // 1.4.13.
      ...
      "benefits" :
      {
        "ca" : "<ul><li></li><li></li><li></li><li></li></ul>", 
        "es" : "<ul><li></li><li></li><li></li><li></li></ul>", 
